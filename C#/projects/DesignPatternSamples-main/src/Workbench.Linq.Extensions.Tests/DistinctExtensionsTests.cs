...
namespace Workbench.Linq.Extensions.Tests
{
    public class DistinctExtensionsTests
    {
        ...
        public void ListagemComItensRepetidosComparecaoSimples()
        {
            ...
            {
                new PessoaFisica() { Nome = "Andre Jaques", NomeMae = "Ana", CPF = "111.111.111-11" },
                new PessoaFisica() { Nome = "Andre Jaques", NomeMae = "Paula", CPF = "111.111.111-11" },
                new PessoaFisica() { Nome = "Andre Jaques", NomeMae = "Ana", CPF = "222.222.222-22" }
            };
